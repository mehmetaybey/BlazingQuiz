...
namespace BlazingQuiz.Api.Migrations
{
    ...
    [Migration("20241120180659_mig_2")]
    partial class mig_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a25c99a8-389d-4eb4-9e88-ce414812b6da"),
                            Email = "admin@gmail.com",
                            IsApproved = true,
                            Name = "Mehmet Aybey",
                            PasswordHash = "AQAAAAIAAYagAAAAEPAY3+pOYkqqk9HaQTXxkrcDo3Yp1m713gPsXgpTbPMbsns0lQzz/D7qKd5+PclA+Q==",
                            Phone = "1234567890",
                            Role = "Admin"
                        });
                });
